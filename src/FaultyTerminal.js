// FaultyTerminal.js - React component with proper OGL checking
// Wait for OGL to be available
if (!window.OGL) {
    console.error('OGL library not found. Make sure it loads before this script.');
}
...
function FaultyTerminal({
  ...
  useEffect(() => {
    ...
    if (!window.OGL || !Renderer) {
      console.error('OGL not available, cannot initialize FaultyTerminal');
      return;
    }

    console.log('Initializing FaultyTerminal with OGL...');
...
console.log('FaultyTerminal component defined');
